...
match "students/past_products" => 'students#pastproducts'
...
match "students/store_info" => 'students#store_info'
match "students/gallery" => 'students#gallery'
...
match "groups/how_it_works" => 'groups#how_it_works'
match "groups/policies" => 'groups#policies'
